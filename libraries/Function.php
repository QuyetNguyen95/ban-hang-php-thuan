...
<?php 
    ...
    **/
    ...
    function base_url()
    {
        ...
        return $url  = "http://localhost/tuanphuongphp/"; 
    }
    ...
    // header() Để điều hướng trang web với hàm header trong PHP các bạn sử dụng cú pháp: header("location: ".$url)
